module "network" {
  ...
  private_subnet_d_name = "dev-codedeploy-practice-private-subnet-d"
  private_subnet_d_cidr_block = "10.0.101.0/24"

  ## Storage
  storage_subnet_c_name = "dev-codedeploy-practice-storage-subnet-a"
  storage_subnet_c_cidr_block = "10.0.200.0/24"

  storage_subnet_d_name = "dev-codedeploy-practice-storage-subnet-d"
  storage_subnet_d_cidr_block = "10.0.201.0/24"
  ...
  private_rt_d_name = "dev-codedeploy-practice-private-d-rt"
  ...
  storage_rt_d_name = "dev-codedeploy-practice-storage-d-rt"
  storage_rt_d_cidr_block = "0.0.0.0/0"
